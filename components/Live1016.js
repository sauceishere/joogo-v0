...
//               { shouldPlay ?
//                 <View style={ styles.playButtonContainer }>
//                   <Text style={{color: 'pink', size: 25}}> Button 0 </Text>
//                   <TouchableOpacity onPress={ this._handlePlayAndPause } style={{height: Dimensions.get('screen').width * 0.7, width: Dimensions.get('screen').width * 0.7}} >  
//                   </TouchableOpacity>
//                 </View>
//               :
...
//                   :
//                     <View>
//                       <Text style={{color: 'pink', size: 25}}> Button 2 </Text>
//                     </View>
//                   }
...
//   playButtonContainer: {
//     // flexGrow:1,
//     height: Dimensions.get('window').width * 0.7, // null,
//     width: Dimensions.get('window').width * 0.7, // null,    
//     alignItems: 'center',
//     justifyContent: 'center', 
//     // zIndex: 202, // removed 20200531
//     // backgroundColor: 'green',
